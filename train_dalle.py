...
from dalle_pytorch.loader import FakeTextImageData, TextImageDataset
from dalle_pytorch.tokenizer import ChineseTokenizer, HugTokenizer, SimpleTokenizer, YttmTokenizer
...
def main(argv):
    ...
    data_group.add_argument(
        '--fake_data',
        action='store_true',
        help='use synthetically generated data instead of --image_text_folder')
    ...
    if RESUME:
        ...
        if distr_backend.BACKEND_NAME == 'DeepSpeed':
    ...
    if ENABLE_WEBDATASET:
        ...
        # Do not shuffle as WebDataset as the behaviour cannot be predicted yet
        ds = (
        ...
        ds = TextImageDataset(
            ...
            tokenizer=tokenizer,
            shuffle=not isinstance(distr_backend, HorovodBackend),
        )
    ...
    if ENABLE_WEBDATASET:
        ...
        dl = DataLoader(ds, batch_size=BATCH_SIZE, shuffle=not data_sampler, drop_last=True, sampler=data_sampler)
